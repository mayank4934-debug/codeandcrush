...
// Poses now map to real person stances
...
// CSS classes on the wrapping div animate the SVG inside
...
export default function AvatarBuilder({
  ...
  // Undo/redo history for config changes
      ...
      >
        ...
        <div className="flex flex-col md:flex-row flex-1 min-h-0">
          ...
          <div className="flex flex-col items-center justify-between gap-3 py-4 px-4 bg-gradient-to-b from-muted/20 to-muted/5 md:w-[42%] md:border-r border-border shrink-0">
            {/* Full-body standing person preview */}
            <div className="flex flex-col items-center gap-2 w-full">
              {/* Avatar preview container — fills width on mobile */}
              <div
                ref={previewRef}
              ...
              >
                {/* Gradient backdrop — like a real room floor/wall */}
                <div
                ...
                {/* Instagram ring overlay at top-right for circle badge */}
                <div
          ...
          <div className="flex flex-col flex-1 min-h-0 min-w-0">
                    ...
                    {customizeTab === "body" && (
                      <div>
                        <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2">
                          Skin Tone{" "}
                          <span className="text-primary/60 font-normal normal-case">
                            — tap to highlight on avatar
                          </span>
                        </p>
                        <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 mb-4">
                          {SKIN_OPTIONS.map((opt) => (
                            <OptionTile
                              ...
                              onClick={() => handleChange({ skinTone: opt.id })}
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-5 gap-2 mb-4">
                          {EYE_SHAPES.map((opt) => (
                            <OptionTile
                              ...
                              onClick={() => handleChange({ eyeShape: opt.id })}
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                          {STORE_ITEMS_BY_CATEGORY.outfits.map((item) => (
                            <OptionTile
                              key={item.id}
                              selected={equippedStoreItems.outfits === item.id}
                              onClick={() => {
            ...
            {mode === "store" && (
              <>
                ...
                {/* Season filter row — only for outfits */}
            ...
            <div className="px-3 py-2 border-t border-border bg-muted/20 shrink-0 flex items-center justify-between gap-2">
              <p className="text-[10px] text-muted-foreground flex items-center gap-1">
                ...
                Complete domain milestones to unlock seasonal items!
              </p>
              <Badge
                variant="outline"
